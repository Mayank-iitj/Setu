...
export const StaggeredMenu = ({
  ...
  onMenuOpen,
  onMenuClose,
  // Setu-specific extra slot rendered inside the panel
  panelExtra = null,
}) => {
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        ...
        <div className="sm-logo" aria-label="Logo">
          {logoUrl
            ? <img src={logoUrl} alt="Setu" className="sm-logo-img" draggable={false} />
            : (
              <a href="/" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#fff', textDecoration: 'none' }}>
                ...
                <span style={{ fontSize: '1.2rem', fontWeight: 600, letterSpacing: '-0.03em', fontFamily: 'Sora, sans-serif' }}>Setu</span>
              </a>
            )
          }
        </div>
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
        <div className="sm-panel-inner">
          ...
          {/* Extra panel content (CTA buttons, etc.) */}
          {panelExtra}
